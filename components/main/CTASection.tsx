...
const CTASection: React.FC = () => {
  return (
    <section className="p-16 mx-2 my-12 text-center rounded-[40px] max-md:p-10 max-md:m-8 bg-gradient-to-r from-[#C093FF] via-[#FFA9EC] to-[#FFC65B] bg-[length:100%_400%] animate-[gradient_8s_ease-in-out_infinite]" aria-label="CTA section">
