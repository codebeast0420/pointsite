...
export const HeroSection = () => {
  return (
    <section className="mt-16 bg-neutral-100 rounded-[40px] max-md:pl-5 max-md:mt-10 max-md:max-w-full">
      <div className="flex gap-5 items-center justify-around max-md:flex-col">
        <Image src={Penny} alt="Penny" className="w-1/2" />
        <div className="w-[42%] max-md:ml-0 max-md:w-full">
          <h1 className="self-stretch my-auto text-4xl font-bold text-black max-md:mt-10">
            Point Exchange
          </h1>
        </div>
