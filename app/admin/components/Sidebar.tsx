	...
	return (
		<>
			...
			<aside className={`w-[28%] max-md:fixed max-md:inset-y-0 max-md:left-0 max-md:w-full max-md:transform max-md:transition-transform max-md:duration-300 ${isOpen ? 'max-md:translate-x-0' : 'max-md:-translate-x-full'
				...
				<div className="flex h-[100vh] justify-between flex-col grow items-center pt-8 pb-16 w-full font-semibold text-black bg-white max-md:mt-10">
					...
					<div className="w-full px-2.5">
						<button className="px-6 py-4 mt-auto text-lg cursor-pointer">Log out</button>
					</div>
				</div>
			</aside>
			{isOpen && (
